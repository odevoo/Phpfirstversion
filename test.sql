...
--
-- Client :  localhost
-- Généré le :  Dim 23 Octobre 2016 à 20:08
...
-- Procédures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `AddGeometryColumn` (`catalog` VARCHAR(64), `t_schema` VARCHAR(64), `t_name` VARCHAR(64), `geometry_column` VARCHAR(64), `t_srid` INT)  begin
...
(1, 'manu', 'sdfksndiufhiqsvduyvugsqdv'),
(2, 'manu', 'hsdvuygqsdf\r\n        '),
(3, 'manu', 'hsdvuygqsdf\r\n        '),
(4, 'manu', 'hsdvuygqsdf\r\n        '),
(5, 'manu', 'shdgvuygsdv\r\n        '),
(6, 'julo', 'dbvsuvvduvusvcd\r\n        '),
(7, 'djnfjinvidf', ',dlkfnjvinjkn\r\n        '),
(8, 'jsbdifb', 'nsjdbisubdvi\r\n        '),
(9, 'nbnocxnbncxvb', '\r\n        '),
(10, 'xcvbxcvb', '\r\n        cvxbxcvb'),
(11, 'idjqoijsdo', 'uhsioudcobh\r\n\r\n        ');
...
(1, 'ma première news', 'je suis le contenu de la première news'),
(2, 'ma deuxième news', 'je suis le contenu de la deuxième news'),
(3, 'ma troisème news', 'je suis le contenu de la troisème news');
